...
docker run -d --restart=always -p 127.0.0.1:27017:27017 -p 127.0.0.1:28017:28017 --name mc_mongodb -v /var/lib/docker_volumes/mc_mongodb:/data/db dockerfile/mongodb:latest
docker run -d --restart=always --name mc_agent -e "MONGOID_ENV=production" -v /var/run/docker.sock:/var/run/docker.sock --link mc_mongodb:mongodb_1 -p 127.0.0.1:1936:1936 -p 8080:80 odaniait/mission-control-agent:latest
...
-p 8080:80 -p 8081:81 -p 8082:82 -p 8083:84 -p 8084:84 -p 8085:85 -p 8086:86 -p 8087:87
