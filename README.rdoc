...
docker run -d --name mc_agent -e "MONGOID_ENV=production" -v /var/run/docker.sock:/var/run/docker.sock --link mc_mongodb:mongodb_1 -p 127.0.0.1:1936:1936 odaniait/mission-control-agent:latest
